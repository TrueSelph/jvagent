...
- Read jvspatial's [`SPEC.md`](../../../jvspatial/SPEC.md) when working close to the graph layer. The reading-list table in [`jvspatial-integration.md`](../jvspatial-integration.md) is ordered by depth.

## References

- [`jvspatial-integration.md`](../jvspatial-integration.md) — the boundary doc.
