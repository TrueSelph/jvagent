...
**Date:** 2026-09-06 · **Status:** Decided 2026-09-06 — PR A landed as [ADR-0051](../adr/0051-protocol-trust-and-runtime-demotion.md) (#205), PR B as [ADR-0052](../adr/0052-reasoning-continuity-between-ticks.md) (#206; unified `assistant_text` replay instead of provider-native thinking blocks, salvage-or-nudge instead of `model_error`, `ollama_chat/` by default). PR C nightly `live.multistep_sop` + Ollama Cloud job landed (`OLLAMA_API_KEY` secret set 2026-09-07); Anthropic signed thinking blocks in the first-party adapter remain open · **Issue:** [TrueSelph/jvagent#203](https://github.com/TrueSelph/jvagent/issues/203) · **Builds on:** [ADR-0044](../adr/0044-native-tool-calling-protocol.md) (protocols), [ADR-0045](../adr/0045-capability-driven-model-integration.md) (capability registry, `tool_protocol: auto`), [ADR-0046](../adr/0046-model-resilience-policy.md) (fault decisions), [ADR-0049](../adr/0049-session-context-placement-and-cache-telemetry.md) (replay/caching)
