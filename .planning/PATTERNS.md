...
- **Avoid when**: A single fixed action fully answers the turn and no model tool-selection is needed (a plain weight-ordered `InteractAction` suffices).
...
The Orchestrator shares the standard harness primitives:
