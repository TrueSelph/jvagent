...
""")
        ...
        info_yaml.write_text("""name: test_action
title: Test Action
version: 1.0.0
...
""")
        ...
        assert any(ns == "test_namespace" and name == "test_agent" for ns, name in agents), "test_agent not found"
...
class TestAppLoader:
    ...
    async def test_app_descriptor_loading(self, temp_dir, test_db):
        ...
        app_yaml.write_text("""app: test_app
version: 1.0.0
author: Test Author
