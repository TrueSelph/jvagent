...
class TestRouterConversationalStateInterpretation:
    ...
    def test_matches_response_to_most_recent_question(self):
        ...
        history = [
            ...
            {"role": "assistant", "content": "Understood. Would you like to keep it private?"},
            {"role": "user", "content": "No"},
            {"role": "assistant", "content": "Alright. Are you submitting this report on behalf of someone else?"},
        ]
        ...
        assert question_pos < history_end, "Most recent question should appear before transition marker"
    ...
    def test_skips_system_events_when_finding_last_question(self):
        ...
        history = [
            ...
            {"role": "system", "content": "[EVENT] Ongoing Activity: EmailCollectionInteractAction"},
        ]
        ...
        assert "Ongoing Activity: EmailCollectionInteractAction" in formatted or \
               "[Ongoing]" in formatted
    ...
    def test_transition_marker_clearly_separates_history_from_current(self):
        ...
        marker_line_idx = [i for i, l in enumerate(lines) if ">>> USER RESPONDS NOW <<<" in l][0]
...
class TestRouterActionMatching:
    ...
    def test_ongoing_activity_recognition_in_context(self):
        ...
        history = [
            ...
            {"role": "system", "content": "[EVENT] Ongoing Activity: SignupInterviewInteractAction"},
        ]
    ...
    def test_multiple_ongoing_activities_uses_most_recent(self):
        ...
        history = [
            ...
            {"role": "user", "content": "Ok"},
            {"role": "system", "content": "[EVENT] Ongoing Activity: CurrentActionName"},
        ]
...
class TestRouterPromptStructure:
    ...
    def test_prompt_shows_history_before_current_message(self):
        ...
        assert history_section_idx < utterance_idx, \
        ...
        assert conv_state_idx < current_msg_idx, \
...
class TestRealisticScenarios:
    ...
    def test_interview_multi_turn_interpretation(self):
        ...
        history = [
            ...
            {"role": "assistant", "content": "Great! Do you have any photos or videos of the incident you'd like to include? You can upload them now or skip this step."},
            {"role": "user", "content": "I do not"},
            {"role": "assistant", "content": "Understood. I noticed that the report includes sensitive information. Would you like to keep it private?"},
            {"role": "user", "content": "No"},
            {"role": "assistant", "content": "Alright. Are you submitting this report on behalf of someone else?"},
        ]
