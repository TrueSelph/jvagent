...
from jvagent.action.interview.core.foundation.enums import ValidationStatus, InterviewState
...
class TestValidation:
    ...
    async def test_valid_response_stored(self, test_session):
        ...
        assert test_session.get_validation_status("user_email") == ValidationStatus.VALID
    ...
    async def test_invalid_response_not_stored(self, test_session):
        ...
        assert test_session.get_validation_status("user_email") == ValidationStatus.INVALID
    ...
    async def test_validation_status_tracking(self, test_session):
        ...
        assert test_session.get_validation_status("user_email") == ValidationStatus.VALID
        assert test_session.get_validation_status("user_name") == ValidationStatus.INVALID
