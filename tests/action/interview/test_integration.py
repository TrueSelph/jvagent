...
from jvagent.action.interview.core.utils.session_utils import cleanup_session, sort_fields_by_question_order
...
class TestIntegration:
    ...
    async def test_session_reset(self, test_session):
        ...
        assert test_session.active_question_key is None
