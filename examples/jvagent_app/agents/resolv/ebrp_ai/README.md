...
A production-ready agent for the Resolv Incident Management System supporting the East Bank Road Improvement Project (Goed Success to Timehri), providing alert dispatch and redress management capabilities.
...
- Integration with Resolv IMS for EBRP Project
...
context:
  alias: EBRP AI Agent
  description: EBRP AI is the virtual assistant for the Resolv IMS System supporting the East Bank Road Improvement Project
  enabled: true
...
{
  "utterance": "I want to report a pothole on the East Bank Road",
  "user_id": null,
  "session_id": null,
  "channel": "default",
  "data": {}
...
4. Agent creates report in Resolv IMS for EBRP Project
...
5. **Project-Specific Workflows** - Custom workflows for EBRP Project needs
