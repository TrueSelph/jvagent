...
A production-ready agent for the Resolv Incident Management System supporting the Improvement of the Road Network near the Port of Paramaribo (ITLCS), providing alert dispatch and redress management capabilities.

## Overview

The ITLCS AI Agent provides:
...
- Integration with Resolv IMS for ITLCS Project
- Speech-to-text and text-to-speech capabilities
- Document retrieval via PageIndex for project information

## Project Context

The ITLCS Project focuses on improving the road network near the Port of Paramaribo to strengthen Suriname's competitive position by improving key infrastructure on and around the Dr. Jules Sedney Haven. Learn more at https://www.itlcs.sr. This agent serves as the virtual assistant providing:
- Subscribing users to traffic alerts and providing the latest traffic updates
- Notifying users about traffic conditions and assisting with managing their traffic report subscriptions efficiently
...
context:
  alias: ITLCS AI
  description: ITLCS AI is the virtual assistant for the Resolv IMS System supporting the ITLCS Project
  enabled: true
...
Conversational agent with ITLCS Project-specific personality and capabilities.

**Configuration:**
- Persona name: "ITLCS AI"
- Model: `gpt-4.1-mini`
- Temperature: 0.1
- Max tokens: 8192

**Persona Description:**
Dedicated virtual assistant for the Resolv IMS System, assigned to the project "Improvement of the road network near the Port of Paramaribo (ITLCS)" to strengthen Suriname's competitive position by improving key infrastructure on and around the Dr. Jules Sedney Haven.

**Capabilities:**
- Subscribe users to traffic alerts and provide the latest traffic updates
- Notify users about traffic conditions and assist with managing their traffic report subscriptions efficiently
...
- Change subscription preferences for notifications
...
{
  "utterance": "I want to report a traffic issue near the port",
  "user_id": null,
  "session_id": null,
  "channel": "default",
  "data": {}
...
1. User: "I want to subscribe to traffic alerts"
...
**ITLCS Project Resolv API:**
- `${RESOLV_TEST_USER_UUID}` - Resolv API user UUID for ITLCS Project
- `${RESOLV_TEST_SECRET_TOKEN}` - Resolv API secret token for ITLCS Project
- `${RESOLV_TEST_API_URL}` - Resolv API URL for ITLCS Project
- `${RESOLV_TEST_ORGANIZATION_SLUG}` - Organization slug in Resolv IMS
- `${RESOLV_TEST_PROJECT_ID}` - ITLCS Project ID in Resolv IMS
...
5. **Project-Specific Workflows** - Custom workflows for ITLCS Project needs
