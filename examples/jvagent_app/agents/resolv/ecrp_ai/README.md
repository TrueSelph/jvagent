...
A production-ready agent for the Resolv Incident Management System supporting the East Coast Road Improvement Project (Sheriff to Mahaica and Annadale to Orange Nassau Road), providing alert dispatch and redress management capabilities.

## Overview

The ECRP AI Agent provides:
...
- Integration with Resolv IMS for ECRP Project
- Speech-to-text and text-to-speech capabilities
- Document retrieval via PageIndex for project information

## Project Context

The ECRP Project focuses on improving the East Coast Road from Sheriff to Mahaica and Annadale to Orange Nassau Road. This agent serves as the virtual assistant providing:

- Updates via notifications on the East Coast Road Improvement Project
...
context:
  alias: ECRP AI Agent
  description: ECRP AI is the virtual assistant for the Resolv IMS System supporting the East Coast Road Improvement Project
  enabled: true
...
Conversational agent with ECRP Project-specific personality and capabilities.

**Configuration:**

- Persona name: "ECRP AI"
- Model: `gpt-4.1-mini`
- Temperature: 0.1
- Max tokens: 8192

**Persona Description:**
Dedicated virtual assistant for the Resolv IMS System, providing clear informational and redress support to residents and commuters affected by the East Coast Road Improvement Project (Sheriff to Mahaica and Annadale to Orange Nassau Road).

**Capabilities:**

- Provide updates via notifications on the East Coast Road Improvement Project
...
{
  "utterance": "I want to report a pothole on the East Coast Road",
  "user_id": null,
  "session_id": null,
  "channel": "default",
  "data": {}
...
**ECRP Project Resolv API:**

- `${RESOLV_TEST_USER_UUID}` - Resolv API user UUID for ECRP Project
- `${RESOLV_TEST_SECRET_TOKEN}` - Resolv API secret token for ECRP Project
- `${RESOLV_TEST_API_URL}` - Resolv API URL for ECRP Project
- `${RESOLV_TEST_ORGANIZATION_SLUG}` - Organization slug in Resolv IMS
- `${RESOLV_TEST_PROJECT_ID}` - ECRP Project ID in Resolv IMS
...
5. **Project-Specific Workflows** - Custom workflows for ECRP Project needs
