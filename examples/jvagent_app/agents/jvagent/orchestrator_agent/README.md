...
- Skills live under `skills/` (app-local), `actions/<ns>/<action>/skills/` (optional action overlays), and `jvagent/skills/` (library); configure via `skills_source` and `skills` in `agent.yaml`.
