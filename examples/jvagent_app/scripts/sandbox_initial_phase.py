...
class ProcessingPhase:
    ...
    async def model_call(prompt: str, model: str = "gpt-4o", context: dict = {}, utterance: str = "") -> dict:
        """Process a single utterance and return results."""
        start = time.time()
        model_action = OpenAIModelAction(
            api_key="YOUR_OPENAI_API_KEY_HERE",
    ...
    async def execute(self, utterance: str, context: Any = None) -> Dict[str, Any]:
        ...
        states:list = [
            ...
            },
            {
                ...
                "constraints": {
                    "description": "existing report was found and the user wish to continue creating the report.",
                    "type": "string",
                    "options": ["yes", "no"]
                },
                "required": True
        ...
        instructions = {
            ...
            # }, {
            #     "condition": "User is talking about report or reporting or making a report but has not specified that it wants you to create a report",
...
async def main():
    ...
    competencies_dict = [
        ...
        },
        {
            ...
            "anchors": ["Message is a request for information", "Message is a request to get the number of incident reports submitted"],
            "actions": [
                {
                    "label": "vector_search",
