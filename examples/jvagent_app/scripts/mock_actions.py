...
Using ONLY the applied parameters and directives as well as the agent role and description:
    ...
    def __init__(self, **kwargs):
        ...
        self.base_parameters = [
            ...
            },
            {
                ...
                "response": "Do not repeat yourself.If no additional information is available from any directives or parameters, do not respond.",
            },
        ]
...
class MockGetIceCreamLocationAction:
    ...
    async def execute(self, utterance: str, context: Any = None) -> Dict[str, Any]:
        ...
        directives = [f"The nearest ice cream parlor is {ice_cream_locations}."]
        instructions = {
            "role": "to get the ice cream locations.",
            "directives": directives,
            "capabilities": ["get ice cream locations"],
            "parameters": [{
                ...
                "condition": "User wants to get ice cream",
                "response": "Ask them if they would like you to suggest some ice cream locations."
            }]
        }
        ...
        return (message, "Got ice cream location")
...
class MockGetUserLocationAction:
    ...
    async def execute(self, utterance: str, context: Any = None) -> Dict[str, Any]:
        ...
        directives = []
        instructions = {
            "role": "to get the user location.",
            "directives": directives,
            "capabilities": ["get user location"],
            "parameters": [{
                "condition": "You are likely to say you have submitted or cancelled a report or are going to do those things a report",
                "response": "Never say you have submitted or cancelled a report or are going to do those things unless instructed to by a directive."
            }, {
...
class MockFilterIceCreamPlacesAction:
    ...
    async def execute(self, utterance: str, context: Any = None) -> Dict[str, Any]:
        ...
        return ("", "Filtered ice cream locations")
