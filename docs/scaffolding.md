...
3. Built-in packaged profiles: `bridge` (default for new agents), `minimal`, `conversational`, `whatsapp_voice`, `research`
...
Bridge+ReasoningHelm agents support two skill sources:
