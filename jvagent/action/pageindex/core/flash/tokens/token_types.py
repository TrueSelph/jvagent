...
class TokenAnchor:
    ...
    def __init__(
        self, line: Line, anchor_span_value, start_offset_value: int, next_number: int
    ):
        self.line = line
...
class Token:
    ...
    def __init__(
        ...
        type_: int,
        candidate_text: str,
        anchor_ranges_value: list[TokenAnchor],
        boundary_flag: bool,
        previous_number: int,
        limit_number: int,
    ):
...
class TokenView:
    ...
    def reverse(self) -> "TokenView":
        return TokenView(
            self.primary_slot, self.end - self.dir, self.start - self.dir, -self.dir
        )
