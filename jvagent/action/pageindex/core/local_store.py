...
def _is_valid_meta(meta, doc_id: str) -> bool:
    ...
    return (
        ...
        and (
            meta.get("description") is None or isinstance(meta.get("description"), str)
        )
        ...
        and page_num >= 0
        and (meta.get("folderId") is None or isinstance(meta.get("folderId"), str))
        and (meta.get("metadata") is None or isinstance(meta.get("metadata"), dict))
