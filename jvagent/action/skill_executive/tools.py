"""Tool primitives for the SkillExecutive loop (ADR-0012).
...
from jvagent.action.skill_executive.access import is_tool_allowed
...
@dataclass
class SkillTool:
    """A tool the SkillExecutive loop can call: name, description, async runner.
