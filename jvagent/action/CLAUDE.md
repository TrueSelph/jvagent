...
> Local guide for the action plugin layer. Cross-link: root [`/CLAUDE.md`](../../CLAUDE.md), [`/.planning/action-authoring.md`](../../.planning/action-authoring.md), [`/.planning/actions-catalog.md`](../../.planning/actions-catalog.md).
...
- **Concrete plugins** organized by topic: language models, response/bus, executive orchestrator + centers, memory-related, channel adapters, productivity integrations, tasks. Catalog in [`/.planning/actions-catalog.md`](../../.planning/actions-catalog.md).
...
Skeleton and full templates: [`/.planning/action-authoring.md`](../../.planning/action-authoring.md).
...
The detailed walkthrough lives at [`/.planning/action-authoring.md`](../../.planning/action-authoring.md) and the runbook at [`/.planning/runbooks/add-action.md`](../../.planning/runbooks/add-action.md). Short version:
...
| `executive/` | (see [`/.planning/adr/0010-executive-centers-architecture.md`](../../.planning/adr/0010-executive-centers-architecture.md)) |
