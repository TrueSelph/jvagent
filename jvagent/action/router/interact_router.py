...
class InteractRouter(InteractAction):
    ...
    enable_dspy_cache: bool = attribute(
        default=False,
        description="Whether to enable DSPy caching (default: False). Caching is disabled by default to prevent bootstrap errors."
    )
    ...
    async def _route_with_dspy(
        ...
        try:
            ...
            lm = DSPyLM(
                ...
                cache=False,  # Cache disabled by default to prevent bootstrap errors
            )
