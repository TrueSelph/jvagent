"""Share a Google Drive file via ActionResolver."""
    ...
    return {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "role": {
                    "type": "string",
                    "description": "Permission role: 'reader', 'writer', or 'owner' (default: 'reader')",
                },
            },
            "required": ["file_id"],
        },
...
async def execute(arguments: Dict[str, Any], *, visitor: Any) -> Any:
    """Share a Drive file by delegating to GoogleDriveAction."""
