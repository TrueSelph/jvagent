...
class Conversation(DeferredSaveMixin, Node):
    ...
    # Removed: get_conversation_history, get_event_history, get_interpretation_history, get_context_history
    # — thin wrappers with no callers; use get_interaction_history directly with appropriate flags
